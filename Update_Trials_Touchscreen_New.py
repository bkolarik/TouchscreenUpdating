...
expName = 'Update_Trials_Touchscreen'  # from the Builder filename that created this script
...
trials_2 = data.TrialHandler(nReps=12, method='random', 
    ...
    trialList=data.importConditions('testFile_v1_touchscreen_6_items_updated_trials.xlsx'),
